...
exports.bookinstance_delete_get = function(req, res, next) {
    BookInstance.findById(req.params.id).populate('book').exec(function(err,results){
      if(err){return next(err);}
      // console.log(results);
      res.render('bookinstance_delete',{title: results.book.title, bookinstance: results})
    })
...
exports.bookinstance_delete_post = function(req, res, next) {
      ...
      BookInstance.findByIdAndDelete(req.body.bookinstanceid, function deleteAuthor(err) {
        if (err) { return next(err); }
